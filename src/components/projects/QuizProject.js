...
const QuizProject = () => {
    ...
    return (
        <>
            ...
            >
                <div
                    className="text-black p-10 pt-36 sm:pt-0 md:pt-0 lg:pt-0 xl:pt-0 2xl:pt-0 3xl:pt-0 rounded-lg w-full max-w-4xl h-3/4">
                    <h1
                    ...
                    <h1
                        ...
                        style={{fontFamily: 'Comfortaa, sans-serif'}}
                    >
                        This page contains the case study of Dopefolio Open-Source Project which includes the Project
                        Overview,

...
const project1 = {
    title: "Y",
    description: "This page contains the case study of Y ProjectDetails which includes the ProjectDetails Overview, Tools Used and Live Links to the official product.",
            ...
            <div
                ...
                <div className="md:w-9/12 text-gray-800 p-4 xxl:px-16 xl:pr-12 py-10">
                    ...
                    <p className="text-xl sm:text-xl md:text-2xl lg:text-xl xl:text-lg 3xl:text-3xl py-4">
                        Y, a social network resembling Twitter, lets you share moments and engage with your community.
